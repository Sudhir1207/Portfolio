...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center font-quicksand space-y-8 bg-[#F2F2F2] md:translate-y-2">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center gap-8">
        <p className="abtPar mb-3 text-center max-w-xl p-[22px] hover:text-red-600">
