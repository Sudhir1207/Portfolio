...
const Hero = () => {
  return (
    <div className="container  gap-1 flex flex-col justify-center items-center h-screen mx-auto p-3 sm:text-nowrap bg-white font-quicksand  ">
      ...
      <div>
        <button className="text-gray-600 transition-transform duration-700 hover:scale-125 mt-36 hover:text-black flex items-center animate-bounce  hover:animate-none ">
